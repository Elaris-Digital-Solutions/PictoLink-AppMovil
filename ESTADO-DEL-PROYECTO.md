...
- **Última actualización:** 2026-08-30 (`E.0.2` **cerrada e integrada** y `E.0.1` **cerrada**: push protection bloquea de verdad, probado con control positivo y negativo. `SEC-16` **resuelta**: los 5 PAT revocados, y la publicación de uno nuevo queda bloqueada. `P0-7` con el código listo y **el panel de Supabase pendiente** — primero se despliega, después se toca el panel)
