...
- **Última actualización:** 2026-08-28 (`E.0.2`: workflow de CI escrito, **sin haber corrido todavía**. `SEC-16` sigue abierta: los 5 PAT no constan revocados)
...
- [x] CI en GitHub Actions ~~← pendiente de decisión del usuario~~ **Desbloqueado por `DEC-7`**
      ...
      como tanda `E.0.2`. **Todavía no ha corrido nunca:** falta el control negativo del plan
