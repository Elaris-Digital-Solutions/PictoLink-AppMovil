...
- **Última actualización:** 2026-08-29 (`E.0.2`: el CI **corrió por primera vez y salió rojo**; causa raíz encontrada y corregida, falta verlo verde. `SEC-16` **parcialmente contenida**: los 3 PAT de este repo revocados (HTTP 401 medido); los 2 de `UPC-Inventario` **siguen sin comprobar**)
...
- [x] CI en GitHub Actions ~~← pendiente de decisión del usuario~~ **Desbloqueado por `DEC-7`**
      ...
      como tanda `E.0.2`. **Corrió por primera vez el 2026-08-29** (PR #2, run `33292231084`) y
      **salió rojo en el paso Typecheck** — un fallo real del gate, no del código: ver el registro
      de cambios del 2026-08-29. Sigue faltando el control negativo del plan
      (un PR con un error de lint a propósito tiene que salir rojo)
